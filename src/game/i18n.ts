...
const de = {
  ...
  ptClockSurvivedHint: 'Erst die Uhr hat die Abstimmung erzwungen',
  ...
  // Uhr und Verbindung
  clockForced: 'Die Uhr hat die Abstimmung erzwungen',
...
const en: Dict = {
  ...
  ptClockSurvivedHint: 'Only the clock forced the vote',
  ...
  clockForced: 'The clock called the vote',
  clockPaused: 'Paused',
